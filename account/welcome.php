                    ...
                    <div class="dashboard">
                        ...
                        <div id="tabs">
                            ...
                            <div id="tabs-2" class="all-tabs">
                                <h2 class="tab-heading">My schedule - TBD</h2>
                            </div>
                            <div id="tabs-3" class="all-tabs">
                                <h2 class="tab-heading">My current orders - -TBD</h2>
                            </div>
                            <div id="tabs-4" class="all-tabs">
                                <h2 class="tab-heading">My previous orders</h2>
                                <?php
                                ...
                                $order_stmt = $conn->prepare("SELECT product_id, price, quantity, size, added_at, shipped_at FROM shipped_orders WHERE user_id = ? ORDER BY shipped_at DESC");
                                ...
                                if ($order_result->num_rows > 0): ?>
                                    ...
                                    <?php else: ?>
                                        <p>You have no previous shipped orders yet.</p>
                                    <?php endif;
                            ...
                            <div id="tabs-5" class="all-tabs">
                                <h2 class="tab-heading">Promocodes - TBD</h2>
                            </div>
